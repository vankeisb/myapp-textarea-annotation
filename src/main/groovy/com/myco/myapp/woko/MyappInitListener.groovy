 ...
 */
class MyappInitListener extends WokoIocInitListener<
    ...
    protected WokoIocContainer<
        ...
        def mailService = new ConsoleMailService("http://www.myapp.com", "info@myapp.com", BindingHelper.createDefaultMailTemplates())
